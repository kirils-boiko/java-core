...
// Note: adjustments made by me:
//  Abstract method implements getters and setters for next and previous link of ListItem;
//  MyLinkedList get(index) method added;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        for (String s : data) {
            ...
            bst.addItem(new Node(s));
        }

        myLinkedList.traverse(myLinkedList.getRoot());
        bst.traverse(bst.getRoot());

        myLinkedList.removeItem(myLinkedList.get(3));   // removing middle element;
        myLinkedList.traverse(myLinkedList.getRoot());

        myLinkedList.removeItem(myLinkedList.get(0));   // removing root element
        myLinkedList.traverse(myLinkedList.getRoot());

        myLinkedList.removeItem(myLinkedList.get(0));   // removing new root element;
        myLinkedList.traverse(myLinkedList.getRoot());

        myLinkedList.removeItem(myLinkedList.get(3));   // removing last element;
        myLinkedList.traverse(myLinkedList.getRoot());

        myLinkedList.removeItem(myLinkedList.get(3));   // removing out-of-range element;
        myLinkedList.traverse(myLinkedList.getRoot());

        myLinkedList.removeItem(new Node("Canberra"));  // removing by value
        myLinkedList.traverse(myLinkedList.getRoot());

        bst.removeItem(new Node("Melbourne"));
        bst.traverse(bst.getRoot());

        bst.removeItem(new Node("Adelaide"));
        bst.traverse(bst.getRoot());
    }
}